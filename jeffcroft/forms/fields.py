...
class NaturalDateTimeField(forms.Field):
    ...
    def __init__(self, *args, **kwargs):
        self.widget = NaturalDateTimeInput()
...
class SplitNaturalDateTimeField(forms.MultiValueField):
    ...
    def __init__(self, *args, **kwargs):
        self.widget = SplitNaturalDateTimeWidget()
        errors = self.default_error_messages.copy()
        if 'error_messages' in kwargs:
            errors.update(kwargs['error_messages'])
        fields = (
            NaturalDateField(error_messages={'invalid': errors['invalid_date']}),
            NaturalTimeField(error_messages={'invalid': errors['invalid_time']}),
        )
